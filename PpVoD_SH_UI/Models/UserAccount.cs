...
namespace PpVoD_SH_UI.Models
{
    public class UserAccount
    {
        ...
        {
            // Create request
            var request = HttpWebRequest.Create(string.Format(@"{0}userAccount/getlogin?email={1}&password=" + HttpUtility.UrlEncode(password), HttpUtility.UrlEncode(email), url));
